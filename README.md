...
[logo_black]: ./documentation/img/flutter_text_decorator_logo_light.png#gh-light-mode-only
[logo_white]: ./documentation/img/flutter_text_decorator_logo_dark.png#gh-dark-mode-only
